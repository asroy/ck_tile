...
DEFINE_FMHA_KERNEL_INVOKE_FUNC((FmhaFwdKernelSelector<64, ck::bhalf_t, true , ck::tile_program::block::GenericAttentionMask<true, true>, true >));
DEFINE_FMHA_KERNEL_INVOKE_FUNC((FmhaFwdKernelSelector<64, ck::bhalf_t, true , ck::tile_program::block::GenericAttentionMask<true, true>, false>));
DEFINE_FMHA_KERNEL_INVOKE_FUNC((FmhaFwdKernelSelector<64, ck::bhalf_t, false, ck::tile_program::block::GenericAttentionMask<true, true>, true >));
DEFINE_FMHA_KERNEL_INVOKE_FUNC((FmhaFwdKernelSelector<64, ck::bhalf_t, false, ck::tile_program::block::GenericAttentionMask<true, true>, false>));
// clang-format on
